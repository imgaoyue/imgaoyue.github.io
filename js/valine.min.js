 ...
 * Valine v1.3.5
 * (c) 2017-2019 xCss
 * Released under the GPL-2.0 License.Update: Mon Apr 01 2019 09:44:44 GMT+0800 (中国标准时间)
 */
!function (e, t) {
	...
	([function (e, t, n) {
				...
				g = {
					...
					en: {
						...
						ctrl: {
							...
							continue: "Continue",
							more: "Load More...",
							try : "Once More?", preview: "Preview", emoji: "Emoji"
						},
						error: {
				...
				r.prototype.init = function (e) {
					...
					try {
						...
						x = e.recordIP,
						w = m.ds,
						_ = a ? "&q=" + Math.random().toString(32).substring(2) : "";
						if (n && r && t.installLocale(n, r), t.locale = t.locale || g[n || "zh-cn"], t.notify = c || !1, t.verify = d || !1, x) {
							var A = u.create("script", "src", "//api.ip.sb/jsonip?callback=getIP"),
						...
						m.params = "?d=" + (w.indexOf(i) > -1 ? i : "mp") + "&v=" + o + _,
						m.hide = "hide" === i,
						m.cdn = h.test(l) ? l : m.cdn,
						y = e.path || y;
						var S = Number(p || 10);
						if (e.pageSize = isNaN(S) ? 10 : S < 1 ? 10 : S, s.setOptions({
						...
						var $ = e.app_id || e.appId,
						E = e.app_key || e.appKey;
						...
						for (var C = u.findAll(document, ".valine-comment-count"), M = 0, T = C.length; M < T; M++)
							!function (e, n) {
								var r = C[e];
								if (r) {
						...
						(M);
						e.visitor && k.add(AV.Object.extend("Counter"));
						var L = e.el || null,
						z = u.findAll(document, L);
						if (!(L = L instanceof HTMLElement ? L : z[z.length - 1] || null))
							return;
						t.el = L,
						...
						var R = (0 == e.meta.length ? b : e.meta).map(function (e) {
						...
						t.alert = {
							show: function (e) {
								...
								if (n.innerHTML = "" + r + (e && e.type && i), u.on("click", u.find(P, ".vcancel"), function (e) {
										t.alert.hide()
									}), u.attr(P, "style", "display:block;"), e && e.type) {
									var o = u.find(P, ".vsure");
							...
							hide: function () {
								return u.attr(P, "style", "display:none;"),
								t
							}
						},
						t.bind(e)
				...
				r.prototype.ErrorHandler = function (e) {
					var t = this;
					if (t.el && t.loading.hide().nodata.hide(), "[object Error]" === {}
						.toString.call(e)) {
						var n = e.code || "",
						r = t.locale.error[n],
				...
				r.prototype.bind = function (e) {
					...
					var M = function (e, n, r) {
						...
						for (var h = u.find(i, ".vat"), v = u.findAll(i, "a"), b = 0, x = v.length; b < x; b++) {
							var y = v[b];
							y && -1 == (u.attr(y, "data-at") || "").indexOf("at") && u.attr(y, {
								target: "_blank",
								rel: "nofollow"
							})
						}
					...
					j = u.find(t.el, ".vsubmit"),
					I = function (e) {
						return u.attr(j, "disabled") ? void t.alert.show({
							type: 0,
							text: t.locale.tips.busy + 'ヾ(๑╹◡╹)ﾉ"',
							ctxt: t.locale.ctrl.ok
						}) : "" == v.comment ? void k.comment.focus() : (v.nick = v.nick || "Anonymous", void(t.notify || t.verify ? N(U) : U()))
					},
					P = function () {
						var e = new AV.ACL;
					...
					U = function () {
						...
						n = new e;
						if (v.url = decodeURI(y), v.insertedAt = new Date, z.rid) {
							var r = z.pid || z.rid;
							n.set("rid", z.rid),
							n.set("pid", r),
							v.comment = v.comment.replace("<p>", '<p><a href="#' + r + '">' + z.at + "</a> , ")
						}
						for (var i in v)
						...
						n.save().then(function (e) {
							...
							try {
								if (z.rid) {
									var i = u.find(t.el, '.vquote[rid="' + z.rid + '"]') || E(z.rid);
									M(e, i, !0)
								} else
									n ? (r = Number(n.innerText) + 1, n.innerText = r) : u.find(t.el, ".vcount").innerHTML = '<span class="num">1</span> ' + t.locale.tips.comments, M(e, u.find(t.el, ".vlist"));
								v.mail && Q({
									username: v.nick,
									mail: v.mail
								}),
								z.at && z.rmail && t.notify && V({
					...
					u.on("keydown", document, function (e) {
						...
						if (((e.ctrlKey || e.metaKey) && 13 === n && I(), 9 === n) && "veditor" == (document.activeElement.id || "")) {
							e.preventDefault();
				...
				d = {
					...
					prop: function (e, t, n) {
						return void 0 !== n ? e[t] = n : "[object Object]" !== {}
						.toString.call(t) ? e[t] : void d.each(t, function (t, n) {
							e[t] = n
						})
					},
					...
					clearAttr: function (e) {
						var t = e.attributes,
						n = ["align", "alt", "disabled", "href", "id", "target", "title", "type", "src"];
